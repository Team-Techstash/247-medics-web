                    ...
                    <div className="grid md:grid-cols-2 items-center">
                        ...
                        >
                            <h1 className="text-2xl md:text-4xl 2xl:text-6xl font-bold text-primary leading-tight mb-4">
                                Online doctor for tourists and travelers
                            </h1>
                            <Image
                        ...
                        >
                            <div className="bg-white p-5 md:p-10 rounded rounded-2xl">
                                ...
                                <ul className="list-disc list-inside mb-4">
                                    <li className="py-2">Answer a few questions</li>
                                    <li className="py-2">Facetime/Zoom with a qualified English-speaking doctor quickly</li>
                                    <li className="py-2">Pick up your medicine from a nearby pharmacy</li>
                                    <li className="py-2">You have 7 days to ask the doctor questions via chat.</li>
                                </ul>
...
export default HeroWhatWeTreat;
