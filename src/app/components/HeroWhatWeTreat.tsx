                        ...
                        >
                            ...
                            <div className="border-t-1 border-top border-secondary/50 py-3 md:py-6 flex items-center gap-4">
                                ...
                                <div className="text-start">
                                    <h4 className="mt-3 md:text-2xl text-primary max-w-150">Get care virtually, starting at</h4>
                        ...
                        >
                            <div className="bg-white p-5 md:p-10 rounded rounded-2xl">
                                ...
                                <ul className="list-disc list-inside mb-4">
                                    <li className="py-2">Video call with a local doctor in under 5 minutes</li>
                                    <li className="py-2">Pick up your medicine from a nearby pharmacy</li>
                                    <li className="py-2">Get a free 7-day follow-up via chat</li>
                                </ul>
